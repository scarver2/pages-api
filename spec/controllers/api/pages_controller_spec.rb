...
describe Api::PagesController do
  ...
  # Page. As you add validations to Api::Page, be sure to
  ...
  describe "GET new" do
    it "assigns a new page as @page" do
      ...
      assigns(:page).should be_a_new(Api::Page)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Api::Page" do
        expect {
          post :create, {:page => valid_attributes}, valid_session
        }.to change(Api::Page, :count).by(1)
      end

      it "assigns a newly created page as @page" do
        post :create, {:page => valid_attributes}, valid_session
        assigns(:page).should be_a(Api::Page)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested page" do
        ...
        # specifies that the Api::Page created on the previous line
